...
\begin{figure}[h]
\centerline{\fbox{\includegraphics[width=0.55\textwidth]{./Imagens/parte1_ex3.jpg}}}
...
\begin{figure}[h]
  \centerline{\fbox{\includegraphics[width=0.3\textwidth]{./Imagens/cmos_grafico.jpg}}}
...
\minipage{0.5\textwidth}
  \centerline{\fbox{\includegraphics[width=0.5\textwidth]{./Imagens/BJT.jpg}}}
  \caption{\\Função lógica \\implementada pelo BJT. \\Vertical: 1V/div (ambos); \\Horizontal: 0,2ms/div (Time A)}\label{bjt}
\endminipage\hfill
\minipage{0.5\textwidth}
  \centerline{\fbox{\includegraphics[width=0.5\textwidth]{Imagens/NMOS.jpg}}}
...
\begin{figure}[h]
  \centerline{\fbox{\includegraphics[width=0.3\textwidth]{./Imagens/pmos_grafico.jpg}}}
...
\endminipage\hfill
\minipage{0.5\textwidth}
  \centerline{\fbox{\includegraphics[width=0.5\textwidth]{Imagens/nmos_vtc.jpg}}}
...
\begin{figure}[!htb]
\minipage{0.5\textwidth}
  \centerline{\fbox{\includegraphics[width=0.5\textwidth]{Imagens/pmos_vtc.jpg}}}
  \caption{\\VTC PMOS \\Vertical: 1V/div ($V_{out}$); \\Horizontal: 1V/div ($V_{in}$)}
\endminipage\hfill
\minipage{0.5\textwidth}
  \centerline{\fbox{\includegraphics[width=0.5\textwidth]{Imagens/cmos_vtc.jpg}}}
...
\begin{figure}[!htb]
\minipage{0.5\textwidth}
  \centerline{\fbox{\includegraphics[width=0.5\textwidth]{./Imagens/cmos_com_condensador_grafico.jpg}}}
...
\begin{figure}[!htb]
\minipage{0.5\textwidth}
  \centerline{\fbox{\includegraphics[width=0.5\textwidth]{./Imagens/pmos_grafico_condensador.jpg}}}
...
\begin{figure}[h]
  \centerline{\fbox{\includegraphics[width=0.5\textwidth]{./Imagens/parte3_exercicio2.jpg}}}
...
\begin{figure}[h]
  \centerline{\fbox{\includegraphics[width=0.4\textwidth]{./Imagens/parte3_exercicio3.jpg}}}
  \caption{Vertical: 1V/div (ambos); \\Horizontal: 0,2ms/div (Time A)}\label{cmos}
\end{figure}
...
\subsection{Calcular para $V_0$, $t_{on}$, T e duty cycle. Explicar porquê que duty cycle $\neq$ 50\%}

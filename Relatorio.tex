...
\minipage{0.5\textwidth}
  \centerline{\fbox{\includegraphics[width=0.5\textwidth]{./Imagens/BJT.jpg}}}
  \caption{\\VTC díodo. \\Vertical: 1V/div (ambos); \\Horizontal: 0,2ms/div (Time A)}\label{bjt}
\endminipage\hfill
\minipage{0.5\textwidth}
  \centerline{\fbox{\includegraphics[width=0.5\textwidth]{Imagens/NMOS.jpg}}}
  \caption{\\VTC CMOS. \\Vertical: 1V/div (ambos); \\Horizontal: 0,2ms/div (Time A)}\label{fig:nmos}
\endminipage\hfill
\end{figure}

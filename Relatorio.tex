...
Quando a amplitude do Vin(t) é 0,2V as ondas sinosoidais coincidem pois esta não é suficiente para fazer com que o díodo conduza. ??? se é limitador não devia ser esta a justificação...

\begin{figure}[h]
\centerline{\fbox{\includegraphics[width=0.6\textwidth]{./Imagens/parte1_ex2_02v_1.jpg}}}
\caption{Vertical: 0,1V/div (ambos); Horiz ontal: 0,1ms/div(A), 1$\mu$s/div(B)}\label{grafico_12_02_osciloscopio}
\end{figure}

...
Para calcular a característica i-v de um díodo, usando os valores obtidos no osciloscópio (\ref{grafico_1c_osciloscopio}) e a fórmula $i = \frac{V\textsubscript{i}-V\textsubscript{0}}{R}$ obtemos a seguinte tabela e gráfico:\newline
...
Quando a amplitude do Vin(t) é 0,2V as ondas sinosoidais coincidem pois esta não é suficiente para fazer com que o díodo conduza. ???
...
Para uma amplitude de 2V, o díodo passa a limitar a tensão em 0,7V (está em corte), como se pode verificar na imagem a seguir:
